...
require_once BP.DS.'app/Unirest.php';
Swarm::register('original_include_path', get_include_path());

if (defined('COMPILER_INCLUDE_PATH')) {
    $appPath = COMPILER_INCLUDE_PATH;
    set_include_path($appPath . PS . Swarm::registry('original_include_path'));
} else {
    /**
     * Set include path
     */
