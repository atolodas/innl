   ...
   protected function getActiveMofluidAppTheme() {
    ...
    protected function sendiOSBuildRequest($selected_mofluid_theme_code) {
		...
		foreach($mofluid_theme_data_colors as $color_key=>$color_val) {
            ...
            $mofluid_theme_color[$color_val["mofluid_color_type"]][$final_color_key] = $color_val["mofluid_color_value"]; 
        }
        ...
        $mofluid_final_resource["mofluid_build_auth_key"] = "QE1vZmx1aWQxLjE1LjBAX0BGcmVlQF9AQnlFYml6b25AX0BTaGFzaGlA";
