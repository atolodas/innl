 ...
 * @author      SLabweb team
 */
class SLab_Dcontent_Block_Adminhtml_Dcontent_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
   /**
   * Prepare  grid
   *
   ...
   */
    ...
    {
    	return Mage::getModel('dcontent/dcontent')->load($this->getRequest()->getParam('id'));
    }
