 ...
 * @author      SLabweb team
 */
class SLab_Dcontent_Block_Adminhtml_Oggettos_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  /**
   * Init grid
   *
  ...
  {
      $collection = Mage::getModel('dcontent/oggettos')->getCollection();
 ...
 /**
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('oggettos', array(
          'header'    => Mage::helper('dcontent')->__('Oggettos'),
          'align'     =>'left',
      	  'type'  => 'action',
          'index'     => 'oggettos',
       	  'filterable' => false,
      	  'renderer'	=> new SLab_Dcontent_Block_Adminhtml_Renderer_Oggettos(),
      ));
