...
class Mage_Adminhtml_Block_Review_Oggetto extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'review_oggettos';
        ...
        $productId = $this->getRequest()->getParam('oggettoId', false);
        $productName = null;
        if ($productId) {
            $product = Mage::getModel('score/oggetto')->load($productId);
