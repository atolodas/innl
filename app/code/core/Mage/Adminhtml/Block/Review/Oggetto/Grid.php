 ...
 */
class Mage_Adminhtml_Block_Review_Oggetto_Grid extends Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Grid
{
    ...
    {
        return $this->getUrl('*/*/oggettoGrid', array('_current'=>true));
    }

    public function getRowUrl($row)
    {
        return $this->getUrl('*/*/jsonOggettoInfo', array('id' => $row->getId()));
    }
