 ...
 */
class Mage_Adminhtml_Block_Review_Oggettos_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $model->getOggettoCollection();

        if ($this->getOggettoId() || $this->getRequest()->getParam('oggettoId', false)) {
            $oggettoId = $this->getOggettoId();
            if (!$oggettoId) {
                $oggettoId = $this->getRequest()->getParam('oggettoId');
            }
            $this->setOggettoId($OggettoId);
            $collection->addEntityFilter($this->getOggettoId());
        }
