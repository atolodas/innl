...
/**
 * Adminhtml all scoretags grid
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Mage_Adminhtml_Block_Scoretag_Scoretag_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct();
        $this->setId('scoretag_scoretag_grid')
             ->setDefaultSort('name')
             ->setDefaultDir('ASC')
             ->setUseAjax(true)
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            ...
            'index'         => 'status',
            'type'          => 'options',
            'options'       => $this->helper('scoretag/data')->getStatusesArray(),
        ));
    ...
    {
        return $this->getUrl('*/scoretag/ajaxGrid', array('_current' => true));
    }
    ...
    {
        return $this->getUrl('*/*/edit', array('scoretag_id' => $row->getId()));
    }
}
