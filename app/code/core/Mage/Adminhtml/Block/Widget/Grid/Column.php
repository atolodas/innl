    ...
    protected function _getRendererByType()
    {
        ...
        switch ($type) {
            ...
            case 'action':
                ...
                break;
            case 'actionfront':
                $rendererClass = 'adminhtml/widget_grid_column_renderer_actionfront';
                break;
            case 'options':
            ...
            case 'store':
                ...
                break;
            case 'counter':
                $rendererClass = 'adminhtml/widget_grid_column_renderer_counter';
                break;
            case 'label':
                $rendererClass = 'adminhtml/widget_grid_column_renderer_label';
                break;
            case 'wrapline':
    ...
    protected function _getFilterByType()
    {
        ...
        switch ($type) {
            ...
            case 'radio':
                ...
                break;
            case 'counter':
                $filterClass = 'adminhtml/widget_grid_column_filter_counter';
                break;
            case 'store':
