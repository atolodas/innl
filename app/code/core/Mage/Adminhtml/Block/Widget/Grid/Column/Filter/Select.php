...
class Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Abstract
{
    ...
    {
        $selected = (((isset($_GET[$this->_getHtmlName()]) && $_GET[$this->_getHtmlName()] == $this->escapeHtml($option['value'])) || ($option['value'] == $value && (!is_null($value)))) ? ' selected="selected"' : '' );
    ...
    public function getCondition()
    {
        ...
        $filter = array(array('like' => $this->getValue()),array('like' => '%,'.$this->getValue()),array('like' => $this->getValue().',%'),array('like' => '%,'.$this->getValue().',%'));
