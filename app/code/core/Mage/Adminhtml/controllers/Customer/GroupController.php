    ...
    public function saveAction()
    {
        ...
        if ($taxClass) {
            try {
                ...
                $customerGroup->setData('store_ids',implode(',',$this->getRequest()->getParam('store_ids')));
                $customerGroup->setData('permissions',$this->getRequest()->getParam('permissions'));
                $customerGroup->setData('parent_id',$this->getRequest()->getParam('parent_id'));
