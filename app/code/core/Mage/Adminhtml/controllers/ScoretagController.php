...
// TODO: this controller still can relate to default Mage_Tag module. fix it later;
class Mage_Adminhtml_ScoretagController extends Mage_Adminhtml_Controller_Action
{

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('score/scoretag')
        ;
    ...
    public function saveAction()
    {
        if ($postData = $this->getRequest()->getPost()) {
            ...
            if (isset($postData['tag_assigned_oggettos'])) {
                $oggettosIds = Mage::helper('adminhtml/js')->decodeGridSerializedInput(
                    $postData['tag_assigned_oggettos']
                );
                $model->setData('tag_assigned_oggettos', $oggettosIds);
            }
    ...
    public function pendingAction()
    {
        ...
        $this->_initAction()
            ...
            ->_setActiveMenu('score/scoretag/pending')
            ->renderLayout();
    }
    ...
    {
        $tagIds = $this->getRequest()->getParam('scoretag');
        if(!is_array($tagIds)) {
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($tagIds)) {
            ...
            try {
                foreach ($tagIds as $tagId) {
                    $tag = Mage::getModel('scoretag/scoretag')
                        ->load($tagId)
