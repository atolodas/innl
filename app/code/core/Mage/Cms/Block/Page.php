 ...
 */
class Mage_Cms_Block_Page extends Mage_Core_Block_Template
{
    /**
    ...
    public function getContent() { 
        return $this->getMessagesBlock()->toHtml() . $this->format($this->getPage()->getContent());
    }

    public function getLeftCol() { 
        return $this->format($this->getPage()->getLeftCol());
    }

    public function getRightCol() { 
        return $this->format($this->getPage()->getRightCol());
    }
