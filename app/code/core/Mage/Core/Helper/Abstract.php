...
abstract class Mage_Core_Helper_Abstract {
	...
	public function isModuleEnabled($moduleName = null) {
		...
		if(Mage::registry('disabled_modules')) { 
			if(in_array($moduleName, array('Mage_Catalog'))) { 
				$moduleName = 'Mage_AllToDisableNonStore';
			}
			$disabled_modules = unserialize(Mage::registry('disabled_modules'));
			if(in_array($moduleName, $disabled_modules)) { return false; } else { return true; } // TODO: when user will be able to enable/disable modules - change this line 
		}
