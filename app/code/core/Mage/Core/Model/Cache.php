...
class Mage_Core_Model_Cache
{
    ...
    public function __construct(array $options = array())
    {
        $this->_defaultBackendOptions['cache_dir'] = isset($options['cache_dir']) ? $options['cache_dir'] :
            ...
            // if($serverName && !substr_count($this->_defaultBackendOptions['cache_dir'], $serverName)) {
            //     $this->_defaultBackendOptions['cache_dir'] = $this->_defaultBackendOptions['cache_dir'] . DS . $serverName;
            // }
        /**
