 ...
 */
class Mage_Review_OggettoController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _initProduct()
    {
        ...
        $product = $this->_loadOggetto($productId);
        if (!$product) {
            return false;
        }
...
*/
     ...
     */
    protected function _loadOggetto($productId)
    {
        if (!$productId) {
            return false;
        }

        $product = Mage::getModel('score/oggetto')
        ...
        Mage::register('current_oggetto', $product);
        Mage::register('oggetto', $product);
    ...
    public function postAction()
    {
        ...
        if (($product = $this->_initProduct()) && !empty($data)) {
            ...
            if ($validate === true) {
                try {
                    $review->setEntityId($review->getEntityIdByCode('oggetto'))
                    ...
                    $review->aggregate();
                    $session->addSuccess($this->__('Your review now live!'));
                }
                catch (Exception $e) {
