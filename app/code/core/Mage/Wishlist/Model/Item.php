    ...
    implements Mage_Catalog_Model_Product_Configuration_Item_Interface
{
   ...
   /**
    ...
    public function validate()
    {
        ...
        if (!$this->getProductId() && !$this->getOggettoId()) {
            Mage::throwException(Mage::helper('wishlist')->__('Cannot specify object.'));
        }
       ...
       public function getOggetto()
    {
        ...
        if (is_null($oggetto)) {
            ...
            $oggetto = Mage::getModel('score/oggetto')
                ->setStoreId($this->getStoreId())
                ->load($this->getOggettoId());

            $this->setData('oggetto', $oggetto);
        }
