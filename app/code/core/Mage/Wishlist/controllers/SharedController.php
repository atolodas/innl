...
class Mage_Wishlist_SharedController extends Mage_Wishlist_Controller_Abstract
{
     ...
     * @return Mage_Wishlist_Model_Wishlist|false
     */
    protected function _getWishlistByCustomerId()
    {
        ...
        $wishlist = Mage::getModel('wishlist/wishlist')->loadByCustomer($id);
        if (!$wishlist->getId()) {
            return false;
        }
    ...
    {
        $wishlist   = $this->_getWishlistByCustomerId();
      
         if ($wishlist && $wishlist->getCustomerId()) {
            $wishlist->setShared(1)->save();
            Mage::register('shared_wishlist', $wishlist);
            if(Mage::registry('wishlist')) Mage::unregister('wishlist');
