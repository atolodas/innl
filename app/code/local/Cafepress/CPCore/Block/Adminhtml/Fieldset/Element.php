...
class Cafepress_CPCore_Block_Adminhtml_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    public function usedDefault()
    {
        ...
        $defaultValue = Mage::getModel('cpcore/xmlformat')->setStoreId(0)->load($this->getDataObject()->getId())->getData($attributeCode);
