...
class Cafepress_CPCore_Block_Adminhtml_Logging_Request extends Mage_Adminhtml_Block_Widget_Form
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('cpcore/logging/request.phtml');
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('resend_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('cpcore')->__('Resend'),
