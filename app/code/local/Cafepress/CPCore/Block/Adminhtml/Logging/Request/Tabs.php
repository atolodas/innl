...
class Cafepress_CPCore_Block_Adminhtml_Logging_Request_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
//    protected $_attributeTabBlock = 'adminhtml/catalog_product_edit_tab_attributes';
    ...
    {
        parent::__construct();
        $this->setTitle(Mage::helper('cpcore')->__('WMS Logging View Request'));
        
        $this->setId('logging_info_tabs');
//        $this->setDestElementId('cplog_info_tabs_general_content');
        $this->setDestElementId('cp_logging_request_form');
...
//        Zend_Debug::dump($log->getData());
        ...
        $this->addTab('general', array(
            ...
            'content'   => $this->_translateHtml($this->getLayout()->createBlock('cpcore/adminhtml_logging_request_tabs_form_general_'.$formatTypeCode)->toHtml()),
            'active'    => true
        ));
...
//                    'active'    => true
                ...
                $this->addTab('example', array(
                    'label'     => Mage::helper('cpcore')->__('Example'),
                    'content'   => $this->_translateHtml($this->getLayout()->createBlock('cpcore/adminhtml_xmlformat_edit_tabs_form_example')->toHtml()),
                ));
            } else {
                $this->addTab('general', array(
                    'label'     => Mage::helper('cpcore')->__('General'),
                    'content'   => $this->_translateHtml($this->getLayout()->createBlock('cpcore/adminhtml_xmlformat_edit_tabs_form_general_'.$formatTypeCode)->toHtml()),
                    'active'    => true
                ));
                $this->addTab('example', array(
                    'label'     => Mage::helper('cpcore')->__('Example'),
