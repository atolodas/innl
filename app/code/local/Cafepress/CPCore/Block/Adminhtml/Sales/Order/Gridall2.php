...
class Cafepress_CPCore_Block_Adminhtml_Sales_Order_Gridall2 extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('grand_total', array(
         ...
         $this->addColumn('cost', array(
            ...
            'type'  => 'currency',
            'currency' => 'base_currency_code',
              'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_Cost()
        ));
        ...
        $this->addColumn('discount_amount', array(
            ...
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_DiscountAmount()
        ));
        ...
        $this->addColumn('total_refunded', array(
            ...
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_TotalRefunded()
        ));

        $this->addColumn('customer_name', array(
            'header' => Mage::helper('sales')->__('Customer Name'),
            'index' => 'customer_name',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_CustomerName()
        ));

        $this->addColumn('customer_group', array(
            'header' => Mage::helper('sales')->__('Customer Group'),
            'index' => 'customer_group',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_CustomerGroup()
        ));

        $this->addColumn('payment_method', array(
            'header' => Mage::helper('sales')->__('Payment Method'),
            'index' => 'payment_method',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_PaymentMethod()
        ));

        $this->addColumn('shipping_name', array(
            'header' => Mage::helper('sales')->__('Shipping Name'),
            'index' => 'shipping_name',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_ShippingName()
        ));

        $this->addColumn('billing_name', array(
            'header' => Mage::helper('sales')->__('Billing Name'),
            'index' => 'billing_name',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_BillingName()
        ));

        $this->addColumn('shipping_1', array(
            'header' => Mage::helper('sales')->__('Shipping Address'),
            'index' => 'shipping_address',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_Shipping()
        ));

        $this->addColumn('company', array(
            'header' => Mage::helper('sales')->__('company'),
            'index' => 'company',
            'renderer' => new Cafepress_CPCore_Block_Adminhtml_Sales_Order_Renderer_Shippingdata()
        ));
