...
class Cafepress_CPCore_Block_Adminhtml_Xmlformat_Edit_Tabs_Form_Downfileparsresp_Request extends Cafepress_CPCore_Block_Adminhtml_Xmlformat_Form
{
    protected function _prepareForm()
    {
        $form = new Varien_Data_Form();
		$form->setDataObject(Mage::registry('current_xmlformat'));
        $fieldset = $form->addFieldset('general', array('legend'=>Mage::helper('cpcore')->__('Download File and Parse Response')));
