...
class Cafepress_CPCore_Block_Adminhtml_Xmlformat_Edit_Tabs_Form_Transformer_Response extends Cafepress_CPCore_Block_Adminhtml_Xmlformat_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $ResponseTypeSource = Mage::getModel('cpcore/resource_eav_mysql4_xmlformat_Responsemethods')->getAllOptions();
