...
class Cafepress_CPCore_Block_Catalog_Product_Edit_Tab_Selectmerchandise extends Mage_Adminhtml_Block_Widget_Form
{
...
//                    'onclick'   => 'setLocation(\'' .$this->getContinueUrl().'\')',
    ...
    {
//        Mage::getModel('cpcore/cafepress_token')->uploadImage($filepath);
        ...
        $fieldset = $form->addFieldset('select_merchant', array('legend'=>Mage::helper('cpcore')->__('Select Product Type')));
        ...
        $fieldset->addType('product_types', 'Cafepress_CPCore_Lib_Varien_Data_Form_Element_ProductTypes');
...
//    {
////        $merchandiseModel = Mage::getModel('cpcore/cafepress_merchandise');
