<?php
class Cafepress_CPCore_Helper_Replacer extends Mage_Core_Helper_Abstract
{
    ...
    public function replace($construction,$replacedValue,$storeId){
        return Mage::getSingleton('cpcore/replacer')->replaceValue($construction,$replacedValue,$storeId);
    }
