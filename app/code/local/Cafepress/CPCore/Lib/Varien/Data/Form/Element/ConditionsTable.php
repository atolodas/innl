...
class Cafepress_CPCore_Lib_Varien_Data_Form_Element_ConditionsTable extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml(){
        ...
        if($format_id){
            $html .= "<script type='text/javascript'>
                    function getTable(){
                        new Ajax.Request('".Mage::getUrl('',array('_secure'=>true)).'cpcore/adminhtml_conditions/index/'."', {
                            method: 'GET',
...
//                                    alert(response.responseText.evalJSON().message);
            ...
            $html .= "<button type='button' onclick='getTable()'><span>".Mage::helper('cpcore')->__('Get Table')."</span></button>";
