 ...
 */
class Cafepress_CPCore_Model_Api_Xmlformat_Type_Orderstatus extends Cafepress_CPCore_Model_Api_Xmlformat_Type_Abstract
{
    /**
     * process request
     *
    ...
    protected function _processRequest(Cafepress_CPCore_Model_Api_Xmlformat $object)
    {
        ...
        $this->_processedData['request_body'] = $template->getProcessedTemplate(
            array('date' => Mage::getModel('wms/xmlformat_variable_date')), true);
        return true;
    }
}
