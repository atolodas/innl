...
class Cafepress_CPCore_Model_Catalog_Product_Import extends Mage_Eav_Model_Convert_Adapter_Entity
{
 public $parser;
 ...
 public function cronJob() {
  //   		Mage::getModel('cpcore/catalog_product_import')->importProductsData();
  //		Mage::getModel('cpcore/catalog_product_import')->getInventoryAdvice();
  echo "Start cron";
  echo "Process acknowledgment";
  $files = array();
  $files = Mage::getModel('cpcore/order_observer')->getFiles($files,'Orderck','acknowledgment');
  Mage::getModel('cpcore/order_observer')->parseAndDeleteAknowledgment($files);

  echo "process shipment";
  $files = array();
  $files = Mage::getModel('cpcore/order_observer')->getFiles($files,'SN','shipment');
