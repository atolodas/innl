...
class Cafepress_CPCore_Model_Replacer extends Mage_Core_Model_Abstract
{
    ...
    protected function _construct() {
        $this->_init('cpreplacer/replacer');
    }
    ...
    public function getLineCodeIdById($code){
        if (!$this->_lineTypes){
            $this->_lineTypes = Mage::helper('cpcore/replacer')->getLineTypes();
        }
    ...
    public function getPossibleValues($construction){
        ...
        $xmlformat = Mage::getModel('cpcore/xmlformat')->setStoreId(0);
