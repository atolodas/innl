...
class Cafepress_CPCore_Model_Resource_Eav_Mysql4_Xmlformat_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Collection_Abstract
{
...
//                    ->setData('response', '')
    ...
    {
        if (!Mage::helper('cpcore')->isDeveloper()){
            //Filter By Type Format
            $devTypeIds = Mage::getModel('cpcore/resource_eav_mysql4_xmlformat_type')->getDeveloperTypeIds();
