...
class Cafepress_CPCore_Model_Resource_Report_Royalty extends Mage_Sales_Model_Resource_Report_Abstract
{
    ...
    public function aggregate($from = null, $to = null)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                sprintf('MIN(%s)',
                    $adapter->getIfNullSql('product_name.sku','product_default_name.sku')
                )
                    ),
                ...
                'row_total'            => new Zend_Db_Expr('SUM(order_item.row_total)'),
                'qty_refunded'       => new Zend_Db_Expr('SUM(order_item.qty_refunded)'),
            );
            ...
            $columns = array(
                ...
                'qty_refunded'                    => new Zend_Db_expr('SUM(qty_refunded)'),
                'product_price'            => new Zend_Db_Expr('SUM(product_price)'),
