...
class Cafepress_CPCore_Adminhtml_ReplacerController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function _initAction() {
        $this->loadLayout()
                ...
                ->_addBreadcrumb(Mage::helper('cpcore')->__('XML Format replacer'), Mage::helper('cpcore')->__('XML Format replacer'));

        $this->_title($this->__('cpcore'))->_title($this->__('XML Format replacer'));
        return $this;
    }
    ...
    protected function _initReplacer() {
        ...
        $replacer = Mage::getModel('cpreplacer/replacer')
                ->setStoreId($storeId);
        if ($replacerId != false) {
    ...
    public function gridAction() {
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('cpcore/adminhtml_replacer_grid')->toHtml()
        );
    }
    ...
    public function editAction() {
        $this->_title($this->__('cpcore'))->_title($this->__('Edit WMS Replace'));
        $this->_initReplacer();
...
//            $xmlformatData = $this->getRequest()->getPost('xmlformat');
    ...
    public function getPossibleValuesAction(){
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($precondition){
                $possibleValues = Mage::getSingleton('cpcore/replacer')->getPossibleValues($precondition);
