...
class Cafepress_CPCore_SyncController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction() {
        ...
        $xmlformatModel = Mage::getModel('cpcore/xmlformat')->getModelFormatByApi('get_colors');
        ...
        $xmlformatModel = Mage::getModel('cpcore/xmlformat')->getModelFormatByApi('get_sizes');
        $xmlformatModel->processRequest();
    ...
    public function productTypesAction(){
        ...
        $merchandise_collection = Mage::getModel('cpcore/cafepress_merchandise')->getMerchandiseCollectionForSync();
