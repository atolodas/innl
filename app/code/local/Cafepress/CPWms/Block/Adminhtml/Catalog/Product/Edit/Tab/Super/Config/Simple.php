...
class Cafepress_CPWms_Block_Adminhtml_Catalog_Product_Edit_Tab_Super_Config_Simple extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Simple//Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Attributes
{
    /**
...
//                Mage::log($attribute->getData(),null,'debug.log');
    ...
    protected function filterConfigOptions($optonName, $options)
    {
        ...
        $optionsArray = Mage::getModel('cpwms/cafepress_merchandise')->getOptions($product,$optonName);
