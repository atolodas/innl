...
class Cafepress_CPWms_Block_Adminhtml_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    public function usedDefault()
    {
        ...
        $defaultValue = Mage::getModel('cpwms/xmlformat')->setStoreId(0)->load($this->getDataObject()->getId())->getData($attributeCode);
