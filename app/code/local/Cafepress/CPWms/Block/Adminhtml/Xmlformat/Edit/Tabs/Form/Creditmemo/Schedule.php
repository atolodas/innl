...
class Cafepress_CPWms_Block_Adminhtml_Xmlformat_Edit_Tabs_Form_Creditmemo_Schedule extends Cafepress_CPWms_Block_Adminhtml_Xmlformat_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('general', array('legend'=>Mage::helper('cpwms')->__('Schedule')));
