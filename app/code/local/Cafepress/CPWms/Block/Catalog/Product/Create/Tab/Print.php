...
class Cafepress_CPWms_Block_Catalog_Product_Create_Tab_Print extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('setprint', array('legend'=>Mage::helper('cpwms')->__('Select CafePress Print')));
        ...
        $fieldset->addType('existing_prints', 'Cafepress_CPWms_Lib_Varien_Data_Form_Element_CPPrints');
