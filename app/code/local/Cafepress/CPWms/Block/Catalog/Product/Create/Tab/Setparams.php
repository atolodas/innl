...
class Cafepress_CPWms_Block_Catalog_Product_Create_Tab_Setparams extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('setprint', array('legend'=>Mage::helper('cpwms')->__('Set Product Params')));
        ...
        foreach(Mage::helper('cpwms')->getAttributeOptions('image_location') as $label){
