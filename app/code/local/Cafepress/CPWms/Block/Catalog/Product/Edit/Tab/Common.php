...
class Cafepress_CPWms_Block_Catalog_Product_Edit_Tab_Common extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareLayout()
    {
        ...
        Varien_Data_Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock('cpwms/adminhtml_fieldset_element')
        );
    }
