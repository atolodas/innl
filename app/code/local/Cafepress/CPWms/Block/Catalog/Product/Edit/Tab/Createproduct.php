...
class Cafepress_CPWms_Block_Catalog_Product_Edit_Tab_Createproduct extends Mage_Adminhtml_Block_Widget_Form
{
...
//                'token' => $this->getRequest()->getParam('token'),
        ...
        $fieldset = $form->addFieldset('create_product', array('legend'=>Mage::helper('cpwms')->__('Create and Save Cofepress Product')));

        $createProduct = array();
        $createProductFields = Mage::helper('cpwms')->getProductCreateAttributes();
        $createProductMediaFields = Mage::helper('cpwms')->getCreateProductMediaConfigurationAttributes();
        $productData = Mage::helper('cpwms')->getProductDataFromXml($product->getCpCreateProductXml());
...
//        ));
        ...
        $productInfo = $form->addFieldset('product_info', array('legend'=>Mage::helper('cpwms')->__('Product Info')));
        ...
        $productInfo->addField('media_configuration', 'label', array(
            ...
            'value'     => '<mediaConfiguration height="'.$product->getMediaHeight().'" name="FrontCenter" designId="'.$product->getDesignId().'"/>',
            'style'     => 'width:50em;',
        ));
