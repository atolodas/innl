...
class Cafepress_CPWms_Block_Catalog_Product_Edit_Tab_Productcreated extends Mage_Adminhtml_Block_Widget_Form
{
...
//                    'onclick'   => 'productForm.submit()',
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('create_product', array('legend'=>Mage::helper('cpwms')->__('Information for the newly created product')));
