...
class Cafepress_CPWms_Block_Catalog_Product_Edit_Tab_Token extends Mage_Adminhtml_Block_Widget_Form
{
...
//            $this->getLayout()->createBlock('adminhtml/widget_button')
//                ->setData(array(
//                    'label'     => Mage::helper('cpwms')->__('Create User Token'),
...
//                );
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('token', array('legend'=>Mage::helper('cpwms')->__('Select Image')));
...
//        $token = Mage::getModel('cpwms/cafepress_token')->get();
        ...
        if($product->getDesignId()){
            $fieldset->addType('cafepress_label', 'Cafepress_CPWms_Lib_Varien_Data_Form_Element_CafepressLabel');
