 ...
 *
 * @method int                                  getType
 * @method Cafepress_CPWms_Model_Api_Xmlformat  setType
 * @method object                               getFormat
 * @method Cafepress_CPWms_Model_Api_Xmlformat  setFormat
 ...
 */
class Cafepress_CPWms_Model_Api_Xmlformat extends Varien_Object
{
    /**
    ...
    public function getTypeInstance($singleton = false)
    {
        if ($singleton === true) {
            if (is_null($this->_typeInstanceSingleton)) {
                $this->_typeInstanceSingleton = Mage::getSingleton('cpwms/api_xmlformat_type')
                    ->factory($this, true);
            }
        ...
        if ($this->_typeInstance === null) {
            $this->_typeInstance = Mage::getSingleton('cpwms/api_xmlformat_type')
                ->factory($this);
        }
