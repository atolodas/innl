 ...
 * @method Cafepress_CPWms_Model_Api_Xmlformat  getXmlFormat
 *
 * @category   Cafepress
 * @package    Cafepress_CPWms
 * @subpackage Model
 ...
 */
class Cafepress_CPWms_Model_Api_Xmlformat_Type_Abstract extends Mage_Core_Model_Abstract
{
    ...
    {
        /** @var $object Cafepress_CPWms_Model_Api_Xmlformat */
        if (!$object) {
     ...
     * @return string|bool
     */
    protected function _processResponse(Cafepress_CPWms_Model_Api_Xmlformat $object)
    {
        return true;
    }
