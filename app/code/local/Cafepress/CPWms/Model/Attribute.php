...
class Cafepress_CPWms_Model_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE   = 0;
    const SCOPE_GLOBAL  = 1;
    const SCOPE_WEBSITE = 2;

    const MODULE_NAME   = 'Cafepress_CPWms';
    const ENTITY        = 'wms_attribute';

    protected $_eventPrefix = 'wms_eav_attribute';
