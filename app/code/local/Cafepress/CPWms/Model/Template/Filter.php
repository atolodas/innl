...
class Cafepress_CPWms_Model_Template_Filter extends Varien_Filter_Template
{
    /**
    ...
    protected $_modifiers = array(
        ...
        'round'             => 'round',
        'str_pad'           => 'str_pad',
        'round02'           => array('Oggetto_Wms_Helper_Data','round02'),
        'month'             => array('Oggetto_Wms_Helper_Data','formatMonth'),
        'date'              => array('Oggetto_Wms_Helper_Data','formatDate'),
        'time'              => array('Oggetto_Wms_Helper_Data','formatTime'),
        'line1'             => array('Oggetto_Wms_Helper_Data','getStreetLine1'),
        'line2'             => array('Oggetto_Wms_Helper_Data','getStreetLine2'),
        'round_money'       => array('Oggetto_Wms_Helper_Data','roundMoney'),
        'shipping_method'   => array('Oggetto_Wms_Helper_Data','codeShippingMethod'),
        'shipping_method_relastin'   => array('Oggetto_Wms_Helper_Data','codeShippingMethodRelastin'),
        'advanced_name'     => array('Oggetto_Wms_Helper_Data','advancedCardName'),
        'double'            => array('Oggetto_Wms_Helper_Data','double'),
        'decrypt'           => array('Mage_Core_Helper_Data','decrypt'),
        'toDate'            => array('Oggetto_Wms_Helper_Data','datetimeToDate'),
        'no_space'          => array('Oggetto_Wms_Helper_Data','noSpace'),
        'shipMethodEncode'  => array('Oggetto_Wms_Helper_Data','shipMethodEncode'),
        'unCdata'           => array('Cafepress_CPWms_Helper_Data','unCdata'),
    ...
    public function functionDirective($construction)
    {
        ...
        return Mage::helper('cpwms')->$method($variableName);
    }
    ...
    public function varDirective($construction)
    {
        ...
        return Mage::helper('cpwms')->addCData($var);
    }
    ...
    public function _getReplacerModel(){
        return Mage::getSingleton('cpwms/replacer');
    }
}
