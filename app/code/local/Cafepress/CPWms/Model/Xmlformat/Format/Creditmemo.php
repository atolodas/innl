...
class Cafepress_CPWms_Model_Xmlformat_Format_Creditmemo extends Cafepress_CPWms_Model_Xmlformat_Format_Abstract
{
    ...
    public function setOrderById($orderId){
        $this->order = Mage::getModel('cpwms/sales_order')->load($orderId);
        return $this;
    }
    public function setCreditmemoById($crId){
        $this->creditmemo = Mage::getModel('cpwms/sales_order')->load($crId);
        return $this;
    }
