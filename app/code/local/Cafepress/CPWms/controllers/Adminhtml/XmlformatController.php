...
class Cafepress_CPWms_Adminhtml_XmlformatController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('sales/wms')
                ->_addBreadcrumb(Mage::helper('cpwms')->__('XML Format Manager'), Mage::helper('cpwms')->__('XML Format Manager'));

        $this->_title($this->__('cpwms'))->_title($this->__('Manage XML Format'));
        return $this;
    }
    ...
    public function indexAction() {
        $this->_title($this->__('cpwms'))->_title($this->__('Manage Wms'));
...
//            }
            $format = Mage::getModel('cpwms/xmlformat');
...
//            $format->validate(); //@todo: resave->not valid uniqui
    ...
    public function gridAction() {
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('cpwms/adminhtml_xmlformat_grid')->toHtml()
        );
    }
    ...
    public function massStatusAction()
    {
        ...
        try {
            foreach($formatsIds as $id){
                $format = Mage::getModel('cpwms/xmlformat')->load($id);
