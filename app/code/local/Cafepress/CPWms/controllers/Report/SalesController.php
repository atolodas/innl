...
class Cafepress_CPWms_Report_SalesController extends Mage_Adminhtml_Report_ProductController
{
    /**
     * init
     *
    ...
    public function royaltyAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('cpwms/adminhtml_royalty'))
            ->renderLayout();
    }
    ...
    public function exportSoldCsvAction()
    {
        ...
        $content    = $this->getLayout()
            ->createBlock('cpwms/adminhtml_royalty_grid')
            ->getCsv();
