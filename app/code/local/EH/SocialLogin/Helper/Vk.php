...
class EH_SocialLogin_Helper_Vk extends Mage_Core_Helper_Abstract
{
    ...
    public function connectByVkId(
            ...
            $token)
    {
        $customer->setEhutSocialloginVkid($vkId)
                ->setEhutSocialloginVktoken($token)
                ->save();
    ...
    public function getCustomersByVkId($vkId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToFilter('ehut_sociallogin_vkid', $vkId)
            ->setPageSize(1);
