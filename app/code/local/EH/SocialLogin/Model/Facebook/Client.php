...
class EH_SocialLogin_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'ehut_sociallogin/facebook/connect';

    const XML_PATH_ENABLED = 'ehut_sociallogin/facebook/enabled';
    const XML_PATH_CLIENT_ID = 'ehut_sociallogin/facebook/api_key';
    const XML_PATH_CLIENT_SECRET = 'ehut_sociallogin/facebook/secret';
...
class EH_SocialLogin_FacebookOAuthException extends Exception
{}
