...
class EH_SocialLogin_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'ehut_sociallogin/google/connect';

    const XML_PATH_ENABLED = 'ehut_sociallogin/google/enabled';
    const XML_PATH_CLIENT_ID = 'ehut_sociallogin/google/api_key';
    const XML_PATH_CLIENT_SECRET = 'ehut_sociallogin/google/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new EH_SocialLogin_GoogleOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ehut_sociallogin')
...
class EH_SocialLogin_GoogleOAuthException extends Exception
{}
