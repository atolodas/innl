...
class EH_SocialLogin_Model_Linkedin_Client
{
    const REDIRECT_URI_ROUTE = 'ehut_sociallogin/linkedin/connect';

    const XML_PATH_ENABLED = 'ehut_sociallogin/linkedin/enabled';
    const XML_PATH_CLIENT_ID = 'ehut_sociallogin/linkedin/api_key';
    const XML_PATH_CLIENT_SECRET = 'ehut_sociallogin/linkedin/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new EH_SocialLogin_LinkedinOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('ehut_sociallogin')
...
class EH_SocialLogin_LinkedinOAuthException extends Exception
{}
