...
class Shaurmalab_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    ...
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Shaurmalab_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Shaurmalab_Commercebug');
    ...
    {	 		
        ob_start();
        include('app/code/local/Shaurmalab/Commercebug/static/' . $path);
        return ob_get_clean();
    }
