...
class Shaurmalab_Commercebug_Model_Collector extends Mage_Core_Helper_Abstract
{
    ...
    public function registerSingleCollector(Shaurmalab_Commercebug_Model_Observingcollector $object)
    {
