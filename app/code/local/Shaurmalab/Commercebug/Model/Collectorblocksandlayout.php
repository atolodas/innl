...
*/
class Shaurmalab_Commercebug_Model_Collectorblocksandlayout extends Shaurmalab_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Shaurmalab_Commercebug') === 0)
            {
                continue;
            }
