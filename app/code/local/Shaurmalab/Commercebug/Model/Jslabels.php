...
class Shaurmalab_Commercebug_Model_Jslabels extends Mage_Core_Model_Abstract
{	
    ...
    public function getLabels()
    {
        ...
        'lookup'=>array(
            'instructions'  => $this->__('Enter an alias (<span class="classname">score/oggetto</span>) or a class name '),
