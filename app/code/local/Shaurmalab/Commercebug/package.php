...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Shaurmalab_Commercebug><active>true</active><codePool>local</codePool></Shaurmalab_Commercebug></modules></config>';
        $string = str_replace('Shaurmalab_', $this->namespace . '_',$string);
