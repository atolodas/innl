<?php
class Shaurmalab_Constructor_Wysiwyg_ImagesController extends Mage_Core_Controller_Front_Action {
	/**
	 * Init storage
	 *
	...
	public function indexAction() {
		...
		if (!is_dir(Mage::helper('cms/wysiwyg_images')->getCurrentPath() . DS . Mage::registry('scode'))) {
			mkdir(Mage::helper('cms/wysiwyg_images')->getCurrentPath() . DS . Mage::registry('scode'));
			chmod(Mage::helper('cms/wysiwyg_images')->getCurrentPath() . DS . Mage::registry('scode'), 0777);
		}
	...
	protected function _saveSessionCurrentPath() {
		...
		$this->getStorage()->getSession()
		     ->setCurrentPath(Mage::helper('cms/wysiwyg_images')->getCurrentPath() . DS . Mage::registry('scode') . DS);
		return $this;
	}
	/**
