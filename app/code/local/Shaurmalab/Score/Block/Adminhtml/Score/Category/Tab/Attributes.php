...
/**
 * Adminhtml Score Category Attributes per Group Tab block
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Category_Tab_Attributes extends Shaurmalab_Score_Block_Adminhtml_Score_Form
{
    /**
     ...
     *
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Category_Tab_Attributes
     */
    protected function _prepareForm() {
        ...
        Mage::dispatchEvent('adminhtml_score_category_edit_prepare_form', array('form'=>$form));
    ...
    {
        return array(
            'image' => Mage::getConfig()->getBlockClassName('score/adminhtml_score_category_helper_image'),
