 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Category_Tab_General extends Shaurmalab_Score_Block_Adminhtml_Score_Form
{
...
//                'name'  => 'path',
//                'label' => Mage::helper('score')->__('Parent Category'),
