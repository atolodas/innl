 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Category_Widget_Chooser extends Shaurmalab_Score_Block_Adminhtml_Score_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('score/category/widget/tree.phtml');
        $this->_withOggettoCount = false;
    }
     ...
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Category_Widget_Chooser
     */
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/score_category_widget/chooser', array('uniq_id' => $uniqId, 'use_massaction' => false));
        ...
        if ($element->getValue()) {
            ...
            if ($categoryId) {
                $label = Mage::getSingleton('score/category')->load($categoryId)->getName();
     ...
     *
     * @return Shaurmalab_Score_Model_Resource_Eav_Mysql4_Category_Collection
     */
    ...
    {
        return $this->getUrl('*/score_category_widget/categoriesJson', array(
            '_current'=>true,
            'uniq_id' => $this->getId(),
