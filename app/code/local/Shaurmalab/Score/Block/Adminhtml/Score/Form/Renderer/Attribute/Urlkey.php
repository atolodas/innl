...
class Shaurmalab_Score_Block_Adminhtml_Score_Form_Renderer_Attribute_Urlkey
    extends Shaurmalab_Score_Block_Adminhtml_Score_Form_Renderer_Fieldset_Element
{
    public function getElementHtml()
    {
        ...
        $data['label'] = Mage::helper('score')->__('Create Permanent Redirect for old URL');
        $data['value'] = $element->getValue();
        $data['checked'] = Mage::helper('score')->shouldSaveUrlRewritesHistory($storeId);
