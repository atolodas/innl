...
/**
 * Score fieldset element renderer
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Form_Renderer_Fieldset_Element
    extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    ...
    {
        $this->setTemplate('score/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Form_Renderer_Fieldset_Element
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($attribute->getFrontendInput() == 'price') {
            $priceScope = Mage::getStoreConfig('score/price/scope');
            if ($priceScope == 0) {
