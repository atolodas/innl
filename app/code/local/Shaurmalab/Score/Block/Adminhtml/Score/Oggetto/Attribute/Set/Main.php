...
/**
 * Adminhtml Score Attribute Set Main Block
 *
 * @category    Mage
 * @package     Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    /**
     * Initialize template
     *
    ...
    {
        $this->setTemplate('score/oggetto/attribute/set/main.phtml');
    }

    /**
     * Prepare Global Layout
     *
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Attribute_Set_Main
     */
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('score/adminhtml_score_oggetto_attribute_set_main_tree_group')
        );

        $this->setChild('edit_set_form',
            $this->getLayout()->createBlock('score/adminhtml_score_oggetto_attribute_set_main_formset')
        );

        $this->setChild('delete_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('score')->__('Delete Selected Group'),
        ...
        $this->setChild('add_group_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('score')->__('Add New'),
        ...
        $this->setChild('save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('score')->__('Save Attribute Set'),
        ...
        $this->setChild('delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('score')->__('Delete Attribute Set'),
                'onclick'   => 'deleteConfirm(\''. $this->jsQuoteEscape(Mage::helper('score')->__('All entitys of this set will be deleted! Are you sure you want to delete this attribute set?')) . '\', \'' . $this->getUrl('*/*/delete', array('id' => $setId)) . '\')',
                'class'     => 'delete'
        )));

        $this->setChild('rename_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => Mage::helper('score')->__('New Set Name'),
    ...
    {
        return Mage::helper('score')->__("Edit Attribute Set '%s'", $this->_getAttributeSet()->getAttributeSetName());
    }
    ...
    {
        return $this->getUrl('*/adminhtml_score_oggetto_set/save', array('id' => $this->_getSetId()));
    }
    ...
    {
        return $this->getUrl('*/adminhtml_score_oggetto_group/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getGroupTreeJson()
    {
        ...
        $configurable = Mage::getResourceModel('score/oggetto_type_configurable_attribute')
    ...
    public function getAttributeTreeJson()
    {
        ...
        if (count($items) == 0) {
            $items[] = array(
                'text'      => Mage::helper('score')->__('Empty'),
                'id'        => 'empty',
                'cls'       => 'folder',
                'allowDrop' => false,
                'allowDrag' => false,
    ...
    {
        Mage::dispatchEvent('adminhtml_score_oggetto_attribute_set_main_html_before', array('block' => $this));
