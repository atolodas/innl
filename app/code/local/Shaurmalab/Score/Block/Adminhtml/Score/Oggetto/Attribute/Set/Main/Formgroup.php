...
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_fieldset', array('legend'=>Mage::helper('score')->__('Add New Group')));
        ...
        $fieldset->addField('submit', 'note',
                            array(
                                'text' => $this->getLayout()->createBlock('adminhtml/widget_button')
                                            ->setData(array(
                                                'label'     => Mage::helper('score')->__('Add Group'),
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/score_oggetto_group/save'));
        $this->setForm($form);
    }
