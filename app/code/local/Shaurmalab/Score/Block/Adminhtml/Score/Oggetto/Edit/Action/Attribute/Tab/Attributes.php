...
/**
 * Adminhtml score entity edit action attributes update tab block
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Action_Attribute_Tab_Attributes
    extends Shaurmalab_Score_Block_Adminhtml_Score_Form
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('adminhtml_score_oggetto_form_prepare_excluded_field_list', array('object'=>$this));

        $form = new Varien_Data_Form();
        $fieldset = $form->addFieldset('fields', array('legend'=>Mage::helper('score')->__('Attributes')));
        $attributes = $this->getAttributes();
        /**
         * Initialize entity object as form property
         * for using it in elements generation
         */
        $form->setDataObject(Mage::getModel('score/oggetto'));
    ...
    /**
     * Retrive attributes for entity massupdate
     *
     * @return array
     */
    public function getAttributes()
    {
        return $this->helper('score/adminhtml_score_oggetto_edit_action_attribute')->getAttributes()->getItems();
    }

    /**
     * Additional element types for entity attributes
     *
     * @return array
     */
    ...
    protected function _getAdditionalElementHtml($element)
    {
        ...
        return '<span class="attribute-change-checkbox"><input type="checkbox" id="' . $element->getId()
             ...
             . '\')" /><label for="' . $element->getId() . '-checkbox">' . Mage::helper('score')->__('Change')
             . '</label></span>
    ...
    {
        return Mage::helper('score')->__('Attributes');
    }
