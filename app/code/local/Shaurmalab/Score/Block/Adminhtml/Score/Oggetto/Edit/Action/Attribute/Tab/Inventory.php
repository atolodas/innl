...
/**
 * Oggettos mass update inventory tab
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Action_Attribute_Tab_Inventory
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('score')->__('Inventory');
    }
