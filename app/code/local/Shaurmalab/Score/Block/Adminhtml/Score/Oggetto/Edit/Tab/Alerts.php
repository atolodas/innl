...
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Alerts extends Mage_Adminhtml_Block_Template
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('score/oggetto/tab/alert.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if ($alertPriceAllow) {
            $accordion->addItem('price', array(
                ...
                'content'   => $this->getLayout()->createBlock('score/adminhtml_score_oggetto_edit_tab_alerts_price')->toHtml() . '<br />',
                'open'      => true
            ));
        }
        if ($alertStockAllow) {
            $accordion->addItem('stock', array(
                ...
                'content'   => $this->getLayout()->createBlock('score/adminhtml_score_oggetto_edit_tab_alerts_stock'),
                'open'      => true
            ));
        }
