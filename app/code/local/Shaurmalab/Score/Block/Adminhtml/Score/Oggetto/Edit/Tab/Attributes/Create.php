...
/**
 * New attribute panel on entity edit page
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Attributes_Create extends Mage_Adminhtml_Block_Widget_Button
{
    /**
    ...
    protected function _toHtml()
    {
        ...
        Mage::dispatchEvent('adminhtml_score_oggetto_edit_tab_attributes_create_html_before', array('block' => $this));
        if (!$this->getCanShow()) {
            return '';
        }
        ...
        $html .= Mage::helper('adminhtml/js')->getScript(
            "var {$this->getJsObjectName()} = new Oggetto.Attributes('{$this->getId()}');\n"
...
} // Class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Attributes_Create End
