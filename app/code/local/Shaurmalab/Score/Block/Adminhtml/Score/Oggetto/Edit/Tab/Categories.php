...
/**
 * Oggetto categories tab
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Categories extends Shaurmalab_Score_Block_Adminhtml_Score_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('score/oggetto/edit/categories.phtml');
    }

    /**
     * Retrieve currently edited entity
     *
    ...
    {
        return $this->getOggetto()->getCategoriesReadonly();
    }

    /**
     * Return array with category IDs which the entity is assigned to
     *
     * @return array
     */
    protected function getCategoryIds()
    {
        return $this->getOggetto()->getCategoryIds();
    }
     ...
     * Returns root node
     *
     * @param Shaurmalab_Score_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current entity)
     *
     * @return array
     */
