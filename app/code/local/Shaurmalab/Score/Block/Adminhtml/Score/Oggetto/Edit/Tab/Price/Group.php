 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Price_Group
    extends Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Price_Group_Abstract
{
    ...
    {
        $this->setTemplate('score/oggetto/edit/price/group.phtml');
    }
     ...
     *
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Price_Group
     */
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('score')->__('Add Group Price'),
