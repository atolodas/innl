...
/**
 * Related entitys admin grid
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Related extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        parent::__construct();
        $this->setId('related_entity_grid');
     ...
     *
     * @param object $column
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Related
     */
    ...
    {
        $collection = Mage::getModel('score/oggetto_link')->useRelatedLinks()
    ...
    {
        return $this->_getOggetto()->getRelatedReadonly();
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('position', array(
            ...
            'index'             => 'position',
            'width'             => 60,
            'editable'          => !$this->_getOggetto()->getRelatedReadonly(),
    ...
    /**
     * Retrieve selected related entitys
     *
     * @return array
     */
    protected function _getSelectedOggettos()
    {
        $entitys = $this->getOggettosRelated();
        if (!is_array($entitys)) {
            $entitys = array_keys($this->getSelectedRelatedOggettos());
        }
        return $entitys;
    }

    /**
     * Retrieve related entitys
     *
     * @return array
     */
    public function getSelectedRelatedOggettos()
    {
        $entitys = array();
        foreach (Mage::registry('current_entity')->getRelatedOggettos() as $entity) {
