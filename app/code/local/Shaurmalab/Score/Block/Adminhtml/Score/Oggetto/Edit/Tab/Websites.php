 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Edit_Tab_Websites extends Mage_Adminhtml_Block_Store_Switcher
{
    ...
    {
        parent::__construct();
        $this->setTemplate('score/oggetto/edit/websites.phtml');
    }

    /**
     * Retrieve edited entity model instance
     *
    ...
    /**
     * Get store ID of current entity
     *
     * @return int
     */
    public function getStoreId()
    {
        return $this->getOggetto()->getStoreId();
    }
    ...
    /**
     * Retrieve array of website IDs of current entity
     *
     * @return array
     */
    public function getWebsites()
    {
        return $this->getOggetto()->getWebsiteIds();
    }

    /**
     * Returns whether entity associated with website with $websiteId
     *
     * @param int $websiteId
     * @return bool
     */
    ...
    {
        return in_array($websiteId, $this->getOggetto()->getWebsiteIds());
    }
    ...
    {
        return $this->getOggetto()->getWebsitesReadonly();
    }
    ...
    public function getChooseFromStoreHtml($storeTo)
    {
        if (!$this->_storeFromHtml) {
            ...
            $this->_storeFromHtml.= '<option value="0">'.Mage::helper('score')->__('Default Values').'</option>';
