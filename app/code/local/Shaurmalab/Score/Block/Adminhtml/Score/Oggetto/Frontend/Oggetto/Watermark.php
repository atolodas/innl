 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Frontend_Oggetto_Watermark extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
    const XML_PATH_IMAGE_TYPES = 'global/score/oggetto/media/image_types';
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        foreach ($attributes as $key => $attribute) {
            ...
            $field->setName("groups[watermark][fields][{$key}_position][value]")
                ...
                ->setRenderer($renderer)
                ->setValues(Mage::getSingleton('adminhtml/system_config_source_score_oggetto_watermark_position')->toOptionArray());
            $html.= $field->toHtml();
        }
