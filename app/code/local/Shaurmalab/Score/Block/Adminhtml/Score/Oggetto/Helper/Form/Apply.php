 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Helper_Form_Apply extends Varien_Data_Form_Element_Multiselect
{
     ...
     * @return Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Helper_Form_Apply
     */
