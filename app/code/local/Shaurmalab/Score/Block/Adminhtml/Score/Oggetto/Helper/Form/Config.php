 ...
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Helper_Form_Config extends Varien_Data_Form_Element_Select
{
    /**
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<input id="'.$htmlId.'" name="entity['.$htmlId.']" '.$disabled.' value="1" ' . $checked;
