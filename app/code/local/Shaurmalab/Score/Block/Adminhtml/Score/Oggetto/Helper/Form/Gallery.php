...
/**
 * Score entity gallery attribute
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Helper_Form_Gallery extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getContentHtml()
    {
        ...
        /* @var $content Shaurmalab_Score_Block_Adminhtml_Score_Oggetto_Helper_Form_Gallery_Content */
        $content = Mage::getSingleton('core/layout')
            ->createBlock('score/adminhtml_score_oggetto_helper_form_gallery_content');
     ...
     *
     * @return Shaurmalab_Score_Model_Oggetto || Shaurmalab_Score_Model_Category
     */
