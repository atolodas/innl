...
/**
 * Score layered navigation view block
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Layer_View extends Mage_Core_Block_Template
{
    /**
     * State block name
     *
    ...
    {
        $this->_stateBlockName              = 'score/layer_state';
        $this->_categoryBlockName           = 'score/layer_filter_category';
        $this->_attributeFilterBlockName    = 'score/layer_filter_attribute';
        $this->_priceFilterBlockName        = 'score/layer_filter_price';
        $this->_decimalFilterBlockName      = 'score/layer_filter_decimal';
    }
    ...
    {
        return 'score/layer_filter_attribute';
    }

    /**
     * Prepare child blocks
     *
     * @return Shaurmalab_Score_Block_Layer_View
     */
     ...
     *
     * @return Shaurmalab_Score_Block_Layer_Filter_Category
     */
     ...
     *
     * @return Shaurmalab_Score_Block_Layer_Filter_Price
     */
