 ...
 */
class Shaurmalab_Score_Block_Navigation extends Mage_Core_Block_Template
{
    /**
     * Category instance
     *
    ...
    protected function _construct()
    {
        ...
        $this->addCacheTag(array(
            Shaurmalab_Score_Model_Category::CACHE_TAG,
    ...
    public function getCurrentChildCategories()
    {
        if (null === $this->_currentChildCategories) {
            ...
            $oggettoCollection = Mage::getResourceModel('score/oggetto_collection');
            $layer->prepareOggettoCollection($oggettoCollection);
            $oggettoCollection->addCountToCategories($this->_currentChildCategories);
        }
    ...
    protected function _getCategoryInstance()
    {
        if (is_null($this->_categoryInstance)) {
            $this->_categoryInstance = Mage::getModel('score/category');
        }
    ...
    {
        if (Mage::getSingleton('score/layer')) {
            return Mage::getSingleton('score/layer')->getCurrentCategory();
        }
        return false;
    }
