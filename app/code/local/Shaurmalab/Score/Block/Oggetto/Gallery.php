 ...
 */
class Shaurmalab_Score_Block_Oggetto_Gallery extends Mage_Core_Block_Template
{
    protected function _prepareLayout()
    {
        if ($headBlock = $this->getLayout()->getBlock('head')) {
            $headBlock->setTitle($this->getOggetto()->getMetaTitle());
        }
    ...
    {
        return $this->getOggetto()->getMediaGalleryImages();
    }
