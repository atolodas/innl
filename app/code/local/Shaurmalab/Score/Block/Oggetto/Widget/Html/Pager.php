...
/**
 * New oggettos widget pager block
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Block_Oggetto_Widget_Html_Pager extends Mage_Page_Block_Html_Pager
{
    /**
     * Collection size
     *
     ...
     * @return  Shaurmalab_Score_Block_Oggetto_Widget_Html_Pager
     */
    ...
    {
        return ($this->getTotalLimit())?$this->getTotalLimit():$this->getCollectionSize();
    }
