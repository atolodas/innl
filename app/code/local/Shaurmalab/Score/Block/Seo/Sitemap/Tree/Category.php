 ...
 */
class Shaurmalab_Score_Block_Seo_Sitemap_Tree_Category extends Shaurmalab_Score_Block_Seo_Sitemap_Category
{
    CONST XML_PATH_LINES_PER_PAGE = 'score/sitemap/lines_perpage';
    ...
    public function bindPager($pagerName)
    {
        ...
        /* @var $pager Shaurmalab_Score_Block_Seo_Sitemap_Tree_Pager */
        if ($pager) {
     ...
     *
     * @return Shaurmalab_Score_Block_Seo_Sitemap_Tree_Category
     */
    public function prepareCategoriesToPages()
    {
        $linesPerPage = Mage::getStoreConfig(self::XML_PATH_LINES_PER_PAGE);
        $tmpCollection = Mage::getModel('score/category')->getCollection()
            ->addIsActiveFilter()
     ...
     *
     * @param Shaurmalab_Score_Model_Category $item
     * @param integer $delta
     * @return integer
     */
