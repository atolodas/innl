 ...
 */
class Shaurmalab_Score_Helper_Category extends Mage_Core_Helper_Abstract
{
    const XML_PATH_CATEGORY_URL_SUFFIX          = 'score/seo/category_url_suffix';
    const XML_PATH_USE_CATEGORY_CANONICAL_TAG   = 'score/seo/category_canonical_tag';
    const XML_PATH_CATEGORY_ROOT_ID             = 'score/category/root_id';
     ...
     * @return  Varien_Data_Tree_Node_Collection|Shaurmalab_Score_Model_Resource_Eav_Mysql4_Category_Collection|array
     */
    public function getStoreCategories($sorted=false, $asCollection=false, $toLoad=true)
    {
        ...
        $recursionLevel  = max(0, (int) Mage::app()->getStore()->getConfig('score/navigation/max_depth'));
    ...
    public function getCategoryUrl($category)
    {
        ...
        return Mage::getModel('score/category')
