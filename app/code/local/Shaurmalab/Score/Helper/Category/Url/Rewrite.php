 ...
 */
class Shaurmalab_Score_Helper_Category_Url_Rewrite
    implements Shaurmalab_Score_Helper_Category_Url_Rewrite_Interface
{
    /**
     * Adapter instance
     *
     ...
     * @param int $storeId
     * @return Shaurmalab_Score_Helper_Category_Url_Rewrite
     */
     ...
     *
     * @param Shaurmalab_Score_Model_Resource_Category_Flat_Collection $collection
     * @param int $storeId
     * @return Shaurmalab_Score_Helper_Category_Url_Rewrite|Shaurmalab_Score_Helper_Category_Url_Rewrite_Interface
     */
    public function joinTableToCollection(Shaurmalab_Score_Model_Resource_Category_Flat_Collection $collection, $storeId)
    {
