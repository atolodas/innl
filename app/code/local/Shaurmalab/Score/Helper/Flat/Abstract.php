...
/**
 * Score flat abstract helper
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
abstract class Shaurmalab_Score_Helper_Flat_Abstract extends Mage_Core_Helper_Abstract
{
    /**
     * Score Flat index process code
     *
     * @var null|string
     */
    ...
    /**
     * Store score Flat index process instance
     *
    ...
    /**
     * Check if Score Flat Data has been initialized
     *
    ...
    /**
     * Check if Score Category Flat Data is available
     * without lock check
     *
     * @return bool
     */
    ...
    /**
     * Check if Score Category Flat Data is available for use
     *
     * @return bool
     */
    ...
    /**
     * Retrieve Score Flat index process
     *
