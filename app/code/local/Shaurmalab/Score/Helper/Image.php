 ...
 */
class Shaurmalab_Score_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
     * @var Shaurmalab_Score_Model_Oggetto_Image
     */
    protected $_model;
     ...
     * @return Shaurmalab_Score_Helper_Image
     */
    public function init(Shaurmalab_Score_Model_Oggetto $oggetto, $attributeName, $imageFile=null)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('score/oggetto_image'));
        ...
        if ($imageFile) {
            ...
            $this->_getModel()->setBaseFile($this->getOggetto()->getData($this->_getModel()->getDestinationSubdir()));
        }
        return $this;
    }
     ...
     *
     * @see Shaurmalab_Score_Model_Oggetto_Image
     * @param int $width
     * @param int $height
     * @return Shaurmalab_Score_Helper_Image
     */
    public function resize($width, $height = null)
    {
        ...
        if($height == null && is_file($this->_getModel()->getBaseFile())) {
            list($w, $h, $type) = getimagesize($this->_getModel()->getBaseFile());
            if($w) { 
	    	$coef = $h / $w;
            	$height = $width * $coef;
            }
	...
	$this->_scheduleResize = true;
     ...
     public function resizeByHeight($height, $width = null)
    {
        if($width == null && $this->_getModel()->getBaseFile()) {
            list($w, $h, $type) = getimagesize($this->_getModel()->getBaseFile());
            $coef = $w / $h;
            $width = $height * $coef;
        }
        $this->_getModel()->setHeight($height)->setWidth($width);
        $this->_scheduleResize = true;
        return $this;
    }
    ...
    public function getPlaceholder()
    {
        if (!$this->_placeholder) {
            ...
            $this->_placeholder = 'images/score/oggetto/placeholder/'.$attr.'.png';
        }
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getOggetto()->getData($model->getDestinationSubdir()));
            }
     ...
     *
     * @param Shaurmalab_Score_Model_Oggetto_Image $model
     * @return Shaurmalab_Score_Helper_Image
     */
     ...
     *
     * @return Shaurmalab_Score_Model_Oggetto_Image
     */
     ...
     * @return Shaurmalab_Score_Helper_Image
     */
    protected function setOggetto($oggetto)
    {
