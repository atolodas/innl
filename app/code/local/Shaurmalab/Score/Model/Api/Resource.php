 ...
 */
class Shaurmalab_Score_Model_Api_Resource extends Mage_Api_Model_Resource_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_resourceAttributeAclName = 'score/category/attributes/field_';
     ...
     */
    protected function _getOggetto($oggettoId, $store = null, $identifierType = null)
    {
        $oggetto = Mage::helper('score/oggetto')->getOggetto($oggettoId, $this->_getStoreId($store), $identifierType);
        if (is_null($oggetto->getId())) {
...
} // Class Shaurmalab_Score_Model_Api_Resource End
