...
/**
 * Abstract Api2 model for oggetto instance
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Api2_Oggetto extends Mage_Api2_Model_Resource
{
    /**
    ...
    public function getAvailableAttributes($userType, $operation)
    {
        ...
        $entityType = Mage::getModel('eav/entity_type')->loadByCode('score_oggetto');
     ...
     * @return bool
     */
    protected function _isAttributeVisible(Shaurmalab_Score_Model_Resource_Eav_Attribute $attribute, $userType)
    {
