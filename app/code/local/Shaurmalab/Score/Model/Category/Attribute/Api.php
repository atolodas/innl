...
/**
 * Score category attribute api
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Category_Attribute_Api extends Shaurmalab_Score_Model_Api_Resource
{
    ...
    {
        $attributes = Mage::getModel('score/category')->getAttributes();
        $result = array();
    ...
    {
        $attribute = Mage::getModel('score/category')
...
} // Class Shaurmalab_Score_Model_Category_Attribute_Api End
