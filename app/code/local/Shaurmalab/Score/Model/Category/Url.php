 ...
 */
class Shaurmalab_Score_Model_Category_Url
{
    /**
     * Url instance
     *
     ...
     * @return string
     */
    public function getCategoryUrl(Shaurmalab_Score_Model_Category $category)
    {
     ...
     * @return string
     */
    protected function _getDirectUrl(Shaurmalab_Score_Model_Category $category)
    {
     ...
     * @return bool|string
     */
    protected function _getRequestPath(Shaurmalab_Score_Model_Category $category)
    {
