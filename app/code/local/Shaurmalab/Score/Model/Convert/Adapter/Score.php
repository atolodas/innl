...
class Shaurmalab_Score_Model_Convert_Adapter_Score
    extends Mage_Dataflow_Model_Convert_Adapter_Abstract
{
    ...
    public function load()
    {
        ...
        $this->setData(array(
            'Oggettos' => $res->exportOggettos(),
            'Categories' => $res->exportCategories(),
            'Image Gallery' => $res->exportImageGallery(),
            'Oggetto Links' => $res->exportOggettoLinks(),
            'Oggettos in Categories' => $res->exportOggettosInCategories(),
            'Oggettos in Stores' => $res->exportOggettosInStores(),
    ...
    public function save()
    {
        ...
        foreach (array('Attributes', 'Attribute Sets', 'Attribute Options', 'Oggettos', 'Categories', ''))
