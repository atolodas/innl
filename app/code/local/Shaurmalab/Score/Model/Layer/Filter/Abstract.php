 ...
 */
abstract class Shaurmalab_Score_Model_Layer_Filter_Abstract extends Varien_Object
{
    /**
     ...
     * @return  Shaurmalab_Score_Model_Layer_Filter_Abstract
     */
    ...
    public function getLayer()
    {
        ...
        if (is_null($layer)) {
            $layer = Mage::getSingleton('score/layer');
     ...
     * @param   mixed $value
     * @param   int $count
     * @return  Shaurmalab_Score_Model_Layer_Filter_Item
     */
    protected function _createItem($label, $value, $count=0)
    {
        return Mage::getModel('score/layer_filter_item')
            ->setFilter($this)
            ->setLabel($label)
            ->setValue($value)
            ->setCount($count);
    ...
    /**
     * Get all oggetto ids from from collection with applied filters
     *
     * @return array
     */
    protected function _getFilterEntityIds()
    {
        return $this->getLayer()->getOggettoCollection()->getAllIdsCache();
    }

    /**
     * Get oggetto collection select object with applied filters
     *
     * @return Varien_Db_Select
     */
    protected function _getBaseCollectionSql()
    {
        return $this->getLayer()->getOggettoCollection()->getSelect();
    }
    ...
    public function getAttributeModel()
    {
        ...
        if (is_null($attribute)) {
            Mage::throwException(Mage::helper('score')->__('The attribute model is not defined'));
        }
        return $attribute;
    }
