...
/**
 * Score Layer Decimal Attribute Filter Model
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Layer_Filter_Decimal extends Shaurmalab_Score_Model_Layer_Filter_Abstract
{
     ...
     * Resource instance
     *
     * @var Shaurmalab_Score_Model_Resource_Eav_Mysql4_Layer_Filter_Decimal
     */
    protected $_resource;
     ...
     *
     * @return Shaurmalab_Score_Model_Resource_Eav_Mysql4_Layer_Filter_Decimal
     */
    protected function _getResource()
    {
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getResourceModel('score/layer_filter_decimal');
        }
        return $this->_resource;
    }

    /**
     * Apply decimal range filter to oggetto collection
     *
     * @param Zend_Controller_Request_Abstract $request
     * @param Shaurmalab_Score_Block_Layer_Filter_Decimal $filterBlock
     * @return Shaurmalab_Score_Model_Layer_Filter_Decimal
     */
    ...
    protected function _renderItemLabel($range, $value)
    {
        ...
        return Mage::helper('score')->__('%s - %s', $from, $to);
    }

    /**
     * Retrieve maximum value from layer oggettos set
     *
     * @return float
     */
    ...
    /**
     * Retrieve minimal value from layer oggettos set
     *
     * @return float
     */
    ...
    /**
     * Retrieve information about oggettos count in range
     *
     * @param int $range
     * @return int
     */
