 ...
 */
class Shaurmalab_Score_Model_Layer_Filter_Price_Algorithm
{
    /**
     ...
     * Prices model
     *
     * @var null|Shaurmalab_Score_Model_Layer_Filter_Price
     */
     ...
     * @return Shaurmalab_Score_Model_Layer_Filter_Price_Algorithm
     */
     ...
     * Set prices model
     *
     * @param Shaurmalab_Score_Model_Layer_Filter_Price $pricesModel
     * @return Shaurmalab_Score_Model_Layer_Filter_Price_Algorithm
     */
            ...
            if ($quantileNumber == 1 && $offset) {
                ...
                if ($additionalPrices) {
                    ...
                    $bestRoundPrice = $this->_findRoundPrice(
                        $prices[0] + Shaurmalab_Score_Model_Resource_Layer_Filter_Price::MIN_POSSIBLE_PRICE / 10,
                        $lastPrice,
                        false
                    );
                }
            ...
            if ($quantileNumber == $this->getIntervalsNumber() - 1) {
                ...
                if ($additionalPrices) {
                    ...
                    $upperBestRoundPrice = $this->_findRoundPrice(
                        $lastPrice + Shaurmalab_Score_Model_Resource_Layer_Filter_Price::MIN_POSSIBLE_PRICE / 10,
    ...
    protected function _findRoundPrice($lowerPrice, $upperPrice, $returnEmpty = true, $roundingFactor = null)
    {
        ...
        while ($tenPower >= Shaurmalab_Score_Model_Resource_Layer_Filter_Price::MIN_POSSIBLE_PRICE) {
            if ($tenPower == Shaurmalab_Score_Model_Resource_Layer_Filter_Price::MIN_POSSIBLE_PRICE) {
            ...
            foreach ($roundingFactorCoefficients as $roundingFactorCoefficient) {
                ...
                if ($roundPrices) {
                    $index = round($roundingFactorCoefficient
                        / Shaurmalab_Score_Model_Resource_Layer_Filter_Price::MIN_POSSIBLE_PRICE);
