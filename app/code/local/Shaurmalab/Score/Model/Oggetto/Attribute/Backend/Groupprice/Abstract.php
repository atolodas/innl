...
/**
 * Score oggetto abstract group price backend attribute model
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
abstract class Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Groupprice_Abstract
    extends Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Price
{
    /**
     ...
     *
     * @param Shaurmalab_Score_Model_Oggetto_Type_Price $priceObject
     * @return bool
     */
     ...
     * @return array
     */
    public function preparePriceData(array $priceData, $oggettoTypeId, $websiteId)
    {
        $rates  = $this->_getWebsiteCurrencyRates();
        $data   = array();
        $price  = Mage::getSingleton('score/oggetto_type')->priceFactory($oggettoTypeId);
    ...
    /**
     * Assign group prices to oggetto data
     *
     * @param Shaurmalab_Score_Model_Oggetto $object
     * @return Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Groupprice_Abstract
     */
    ...
    public function afterSave($object)
    {
        ...
        $isChanged  = false;
        $oggettoId  = $object->getId();

        if (!empty($delete)) {
            foreach ($delete as $data) {
                $this->_getResource()->deletePriceData($oggettoId, null, $data['price_id']);
                $isChanged = true;
            }
        }
