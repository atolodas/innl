...
/**
 * Score oggetto price attribute backend model
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Price extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    /**
     ...
     * @return Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Price
     */
    ...
    public function setScope($attribute)
    {
        if (Mage::helper('score')->isPriceGlobal()) {
            $attribute->setIsGlobal(Shaurmalab_Score_Model_Resource_Eav_Attribute::SCOPE_GLOBAL);
        }
        else {
            $attribute->setIsGlobal(Shaurmalab_Score_Model_Resource_Eav_Attribute::SCOPE_WEBSITE);
        }
    ...
    public function afterSave($object)
    {
        ...
        if ($this->getAttribute()->getIsGlobal() == Shaurmalab_Score_Model_Resource_Eav_Attribute::SCOPE_WEBSITE) {
