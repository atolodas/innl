...
class Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Startdate extends Mage_Eav_Model_Entity_Attribute_Backend_Datetime
{
   /**
    ...
    *
    * @param Varien_Object $object
    * @return Shaurmalab_Score_Model_Oggetto_Attribute_Backend_Startdate
    */
   ...
   /**
    * Oggetto from date attribute validate function.
    ...
    */
    public function validate($object)
    {
        ...
        if ($maxDate) {
            ...
            if ($value > $maxValue) {
                $message = Mage::helper('score')->__('The From Date value should be less than or equal to the To Date value.');
