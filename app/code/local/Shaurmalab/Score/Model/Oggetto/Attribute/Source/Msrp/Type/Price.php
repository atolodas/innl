...
/**
 * Source model for 'msrp_display_actual_price_type' oggetto attribute
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Oggetto_Attribute_Source_Msrp_Type_Price
    extends Shaurmalab_Score_Model_Oggetto_Attribute_Source_Msrp_Type
{
    /**
    ...
    public function getAllOptions()
    {
        if (!$this->_options) {
            ...
            $this->_options[] = array(
                'label' => Mage::helper('score')->__('Use config'),
