 ...
 */
class Shaurmalab_Score_Model_Oggetto_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('score/oggetto_media_config')->getBaseMediaPath();
        ...
        if (!$file) {
            ...
            $isConfigPlaceholder = Mage::getStoreConfig("score/placeholder/{$this->getDestinationSubdir()}_placeholder");
            ...
            if ($isConfigPlaceholder && $this->_fileExists($baseDir . $configPlaceholder)) {
                ...
                $skinPlaceholder = "/images/score/oggetto/placeholder/{$this->getDestinationSubdir()}.png";
        ...
        if ((!$file) || (!file_exists($baseFile))) {
                    throw new Exception(Mage::helper('score')->__('Image file was not found.'));
        }
        ...
        $path = array(
            Mage::getSingleton('score/oggetto_media_config')->getBaseMediaPath(),
            'cache',
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'score'.DS.'oggetto'.DS.'cache'.DS;
