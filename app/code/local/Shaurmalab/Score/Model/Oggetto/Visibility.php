...
/**
 * Score Oggetto visibilite model and attribute source model
 *
 * @category   Mage
 * @package    Shaurmalab_Score
 * @author     Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Oggetto_Visibility extends Varien_Object
{
    ...
    /**
     * Add visible in score filter to collection
     *
     * @deprecated
     * @param Mage_Eav_Model_Entity_Collection_Abstract $collection
     * @return Shaurmalab_Score_Model_Oggetto_Visibility
     */
    public function addVisibleInScoreFilterToCollection(Mage_Eav_Model_Entity_Collection_Abstract $collection)
    {
        $collection->setVisibility($this->getVisibleInScoreIds());
//        $collection->addAttributeToFilter('visibility', array('in'=>$this->getVisibleInScoreIds()));
        return $this;
    }
    ...
    /**
     * Retrieve visible in score ids array
     *
     * @return array
     */
    public function getVisibleInScoreIds()
    {
    ...
    {
        return array(
            self::VISIBILITY_NOT_VISIBLE=> Mage::helper('score')->__('Disabled'),
            // self::VISIBILITY_IN_CATALOG => Mage::helper('score')->__('Catalog'),
            // self::VISIBILITY_IN_SEARCH  => Mage::helper('score')->__('Search'),
            self::VISIBILITY_BOTH       => Mage::helper('score')->__('Visible')
        );
    }
    ...
    {
        $res = array();
        $res[] = array('value'=>'', 'label'=> Mage::helper('score')->__('-- Please Select --'));
    ...
    public function getFlatColums()
    {
        ...
        if (Mage::helper('core')->useDbCompatibleMode()) {
            ...
            $column['comment']  = 'Catalog Oggetto Visibility ' . $attributeCode . ' column';
        }
