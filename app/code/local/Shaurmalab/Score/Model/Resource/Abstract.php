...
/**
 * Score entity abstract model
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
abstract class Shaurmalab_Score_Model_Resource_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    /**
    ...
    {
        return 'score/resource_eav_attribute';
    }
    ...
    {
        $select->columns(
            Mage::getResourceHelper('score')->attributeSelectFields('attr_table', $type)
        );
        return $select;
    }
     ...
     *
     * @param Shaurmalab_Score_Model_Abstract $object
     * @param array $valueRow
     * @return Shaurmalab_Score_Model_Resource_Abstract
     */
     ...
     * @see Shaurmalab_Score_Model_Resource_Abstract::_saveAttributeValue()
     *
     * @param Varien_Object $object
     * @param Mage_Eav_Model_Entity_Attribute_Abstract $attribute
     * @param mixed $valueId
