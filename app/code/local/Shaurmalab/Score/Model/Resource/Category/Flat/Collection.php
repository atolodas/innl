...
/**
 * Score category flat collection
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Resource_Category_Flat_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Event prefix
     *
    ...
    protected function _construct()
    {
        ...
        $this->setModel('score/category');
    }

    /**
     * Enter description here ...
     *
     * @return Shaurmalab_Score_Model_Resource_Category_Flat_Collection
     */
