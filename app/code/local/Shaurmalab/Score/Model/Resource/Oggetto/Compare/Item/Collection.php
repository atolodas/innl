...
/**
 * Score Oggetto Compare Items Resource Collection
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Resource_Oggetto_Compare_Item_Collection
    extends Shaurmalab_Score_Model_Resource_Oggetto_Collection
{
    ...
    {
        $this->_init('score/oggetto_compare_item', 'score/oggetto');
        $this->_initTables();
    }
     ...
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Compare_Item_Collection
     */
    ...
    {
        $this->joinTable(
            array('t_compare' => 'score/compare_item'),
            ...
            array(
                ...
                'score_compare_item_id' => 'score_compare_item_id'
            ),
            $this->getConditionForJoin()
        );

        $this->_oggettoLimitationFilters['store_table']  = 't_compare';

        return $this;
    }

    /**
     * Retrieve comapre oggettos attribute set ids
     *
     * @return array
     */
    protected function _getAttributeSetIds()
    {
        ...
        $compareConds = array(
            'compare.oggetto_id=entity.entity_id',
        );
        if ($this->getCustomerId()) {
        ...
        $websiteConds = array(
            'website.oggetto_id = entity.entity_id',
        ...
        $select = $this->getConnection()->select()
            ...
            ->join(
                ...
                array())
            ->join(
                array('compare' => $this->getTable('score/compare_item')),
    ...
    /**
     * Retrieve Merged comparable attributes for compared oggetto items
     *
     * @return array
     */
    ...
    /**
     * Use oggetto as collection item
     *
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Compare_Item_Collection
     */
    public function useOggettoItem()
    {
        $this->setObject('score/oggetto');
    ...
    /**
     * Retrieve oggetto ids from collection
     *
     * @return array
     */
    ...
    {
        Mage::getResourceSingleton('score/oggetto_compare_item')
            ->clearItems($this->getVisitorId(), $this->getCustomerId());
        Mage::dispatchEvent('score_oggetto_compare_item_collection_clear');
    ...
    {
        if (!Mage::helper('score/oggetto_compare')->getAllowUsedFlat()) {
            return false;
        }
