...
/**
 * Score Oggetto Flat resource model
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Resource_Oggetto_Flat extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Store scope Id
     *
    ...
    /**
     * Store flag which defines if Score Oggetto Flat Data has been initialized
     *
     * @var array
     */
    ...
    {
        $this->_init('score/oggetto_flat', 'entity_id');
     ...
     *
     * @param mixed $store
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Flat
     */
    ...
    public function getFlatTableName($store = null)
    {
        ...
        return $this->getTable(array('score/oggetto_flat', $store));
    }
