 ...
 */
class Shaurmalab_Score_Model_Resource_Oggetto_Option_Value extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('score/oggetto_option_type_value', 'option_type_id');
    }
    ...
    {
        $priceTable = $this->getTable('score/oggetto_option_type_price');
    ...
    {
        $titleTable = $this->getTable('score/oggetto_option_type_title');
     ...
     *
     * @param int $optionId
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Option_Value
     */
    public function deleteValue($optionId)
    {
        $statement = $this->_getReadAdapter()->select()
            ->from($this->getTable('score/oggetto_option_type_value'))
    ...
    public function deleteValues($optionTypeId)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('score/oggetto_option_type_price'),
            $condition
        );

        $this->_getWriteAdapter()->delete(
            $this->getTable('score/oggetto_option_type_title'),
            $condition
        );
    }
     ...
     *
     * @param Shaurmalab_Score_Model_Oggetto_Option_Value $object
     * @param int $oldOptionId
     * @param int $newOptionId
     * @return Shaurmalab_Score_Model_Oggetto_Option_Value
     */
    public function duplicate(Shaurmalab_Score_Model_Oggetto_Option_Value $object, $oldOptionId, $newOptionId)
    {
