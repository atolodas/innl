...
/**
 * Score oggetto option values collection
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Resource_Oggetto_Option_Value_Collection
    extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     *
     * @param int $storeId
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Option_Value_Collection
     */
    ...
    public function addTitlesToResult($storeId)
    {
        ...
        $optionTypePriceTable = $this->getTable('score/oggetto_option_type_price');
        $optionTitleTable     = $this->getTable('score/oggetto_option_type_title');
        ...
        $joinExprDefaultPrice = 'default_value_price.option_type_id = main_table.option_type_id AND '
                  . $adapter->quoteInto('default_value_price.store_id = ?', Shaurmalab_Score_Model_Abstract::DEFAULT_STORE_ID);
        ...
        $this->getSelect()
            ...
            ->where('default_value_title.store_id = ?', Shaurmalab_Score_Model_Abstract::DEFAULT_STORE_ID);
    ...
    {
        $optionTypeTable = $this->getTable('score/oggetto_option_type_price');
        ...
        $joinExprDefault = 'default_value_price.option_type_id = main_table.option_type_id AND '
                        . $this->getConnection()->quoteInto('default_value_price.store_id = ?', Shaurmalab_Score_Model_Abstract::DEFAULT_STORE_ID);
     ...
     *
     * @param array|Shaurmalab_Score_Model_Oggetto_Option|int $option
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Option_Value_Collection
     */
    public function addOptionToFilter($option)
    {
        ...
        } elseif ($option instanceof Shaurmalab_Score_Model_Oggetto_Option) {
