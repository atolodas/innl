...
/**
 * Score Oggetto Relations Resource model
 *
 * @category    Mage
 * @package     Shaurmalab_Score
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_Score_Model_Resource_Oggetto_Relation extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('score/oggetto_relation', 'parent_id');
    }

    /**
     * Save (rebuild) oggetto relations
     *
     * @param int $parentId
     * @param array $childIds
     * @return Shaurmalab_Score_Model_Resource_Oggetto_Relation
     */
