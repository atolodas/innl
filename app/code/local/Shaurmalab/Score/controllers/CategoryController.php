 ...
 */
class Shaurmalab_Score_CategoryController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    {
        Mage::dispatchEvent('score_controller_category_init_before', array('controller_action' => $this));
        ...
        Mage::getSingleton('score/session')->setLastVisitedCategoryId($category->getId());
        Mage::register('current_category', $category);
        Mage::register('current_entity_key', $category->getPath());

        try {
            Mage::dispatchEvent(
                'score_controller_category_init_after',
                array(
                    'category' => $category,
     ...
     *
     * @return Shaurmalab_Score_CategoryController
     */
    ...
    public function viewAction()
    {
        if ($category = $this->_initCatagory()) {
            ...
            Mage::getSingleton('score/session')->setLastViewedCategoryId($category->getId());

            $update = $this->getLayout()->getUpdate();
            $update->addHandle('default');

            if (!$category->hasChildren()) {
                $update->addHandle('score_category_layered_nochildren');
            }
