...
/** @var $eavResource Shaurmalab_Score_Model_Resource_Eav_Attribute */
$eavResource = Mage::getResourceModel('score/eav_attribute');
...
foreach($multiSelectAttributeCodes as $attributeCode) {
    ...
    $attribute = $installer->getAttribute('score_oggetto', $attributeCode);
    if ($attribute) {
        $attributeTable = $installer->getAttributeTable('score_oggetto', $attributeCode);
