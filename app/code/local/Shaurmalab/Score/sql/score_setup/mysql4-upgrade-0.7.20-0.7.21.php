...
$attributes = array(
    $installer->getAttributeId('score_oggetto', 'price'),
    $installer->getAttributeId('score_oggetto', 'special_price'),
    $installer->getAttributeId('score_oggetto', 'special_from_date'),
    $installer->getAttributeId('score_oggetto', 'special_to_date'),
    $installer->getAttributeId('score_oggetto', 'cost'),
    $installer->getAttributeId('score_oggetto', 'tier_price'),
);
