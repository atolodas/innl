...
$attributeId    = $installer->getAttributeId('score_category', 'is_active');
$entityTypeId   = $installer->getEntityTypeId('score_category');
$installer->updateAttribute('score_category', 'is_active', 'backend_type', 'int');

$categoryIntTable = $installer->getTable('score_category_entity_int');
$categoryTable = $installer->getTable('score_category_entity');
