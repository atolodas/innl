...
$entityTypeId   = $installer->getEntityTypeId('score_oggetto');
$sqlAttributes  = $installer->getConnection()->quoteInto('?',
    Mage::getSingleton('score/config')->getOggettoCollectionAttributes()
);
$installer->run("
...
$installer->getConnection()->addKey(
    ...
    array('entity_type_id','used_in_oggetto_listing')
);
...
// Add Score Default Sort Attributes
