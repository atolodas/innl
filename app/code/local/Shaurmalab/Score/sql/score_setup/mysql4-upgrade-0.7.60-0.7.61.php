...
$tableCatalogOggetto = $this->getTable('score/oggetto');

$types = array('datetime', 'decimal', 'int', 'text', 'varchar');

foreach ($types as $type) {
    $tableName = $tableCatalogOggetto . '_' . $type;
...
$tableName = $tableCatalogOggetto . '_gallery';
...
$installer->getConnection()->addKey("{$tableCatalogOggetto}_gallery", 'IDX_BASE', array('entity_type_id','entity_id','attribute_id','store_id'), 'unique');
