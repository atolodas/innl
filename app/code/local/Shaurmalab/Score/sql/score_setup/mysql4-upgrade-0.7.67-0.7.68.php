...
$installer->getConnection()->addColumn($installer->getTable('score/oggetto'), 'required_options', 'tinyint(1) unsigned NOT NULL default 0');

$entityTypeId   = 'score_oggetto';
...
if ($attributeTable != $installer->getTable('score/oggetto')) {
    $installer->run("
    UPDATE `{$installer->getTable('score/oggetto')}` AS `p`
