...
$installer->updateEntityType('score_category', 'additional_attribute_table', 'score/eav_attribute');
$installer->updateEntityType('score_oggetto', 'additional_attribute_table', 'score/eav_attribute');
$installer->updateEntityType('score_category', 'entity_attribute_collection', 'score/attribute_collection');
$installer->updateEntityType('score_oggetto', 'entity_attribute_collection', 'score/attribute_collection');
$installer->run("
...
$stmt = $installer->getConnection()->select()
    ...
    ->where('entity_type_id = ?', $installer->getEntityTypeId('score_category'))
    ->orWhere('entity_type_id = ?', $installer->getEntityTypeId('score_oggetto'));
$result = $installer->getConnection()->fetchAll($stmt);
$table = $installer->getTable('score/eav_attribute');
...
$prefix = Shaurmalab_Score_Model_Oggetto_Attribute::MODULE_NAME.Mage_Core_Model_Translate::SCOPE_SEPARATOR;
$sql = "
    INSERT
