 ...
 *
 * @method Shaurmalab_ScoreIndex_Model_Resource_Aggregation _getResource()
 * @method Shaurmalab_ScoreIndex_Model_Resource_Aggregation getResource()
 * @method int getStoreId()
 * @method Shaurmalab_ScoreIndex_Model_Aggregation setStoreId(int $value)
 * @method string getCreatedAt()
 * @method Shaurmalab_ScoreIndex_Model_Aggregation setCreatedAt(string $value)
 * @method string getKey()
 * @method Shaurmalab_ScoreIndex_Model_Aggregation setKey(string $value)
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreIndex
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreIndex_Model_Aggregation extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init('scoreindex/aggregation');
    }
    ...
    /**
     * Clear all cache data related with oggettos
     *
     * @param   int|array $oggettoIds
     * @return  Shaurmalab_ScoreIndex_Model_Aggregation
     */
    public function clearOggettoData($oggettoIds)
    {
        // $categoryPaths = $this->_getResource()->getOggettoCategoryPaths($oggettoIds);
        // if (!empty($categoryPaths)) {
        //     $tags = array();
        //     foreach ($categoryPaths as $path) {
        //         $tags[] = Shaurmalab_Score_Model_Category::CACHE_TAG.':'.$path;
        //     }
