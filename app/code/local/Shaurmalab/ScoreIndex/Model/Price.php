 ...
 * Price index model
 *
 * @method Shaurmalab_ScoreIndex_Model_Resource_Price _getResource()
 * @method Shaurmalab_ScoreIndex_Model_Resource_Price getResource()
 * @method Shaurmalab_ScoreIndex_Model_Price setEntityId(int $value)
 * @method int getCustomerGroupId()
 * @method Shaurmalab_ScoreIndex_Model_Price setCustomerGroupId(int $value)
 * @method int getWebsiteId()
 * @method Shaurmalab_ScoreIndex_Model_Price setWebsiteId(int $value)
 * @method int getTaxClassId()
 * @method Shaurmalab_ScoreIndex_Model_Price setTaxClassId(int $value)
 * @method float getPrice()
 * @method Shaurmalab_ScoreIndex_Model_Price setPrice(float $value)
 * @method float getFinalPrice()
 * @method Shaurmalab_ScoreIndex_Model_Price setFinalPrice(float $value)
 * @method float getMinPrice()
 * @method Shaurmalab_ScoreIndex_Model_Price setMinPrice(float $value)
 * @method float getMaxPrice()
 * @method Shaurmalab_ScoreIndex_Model_Price setMaxPrice(float $value)
 * @method float getTierPrice()
 * @method Shaurmalab_ScoreIndex_Model_Price setTierPrice(float $value)
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreIndex
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreIndex_Model_Price extends Mage_Core_Model_Abstract
{
    protected function _construct()
    {
        $this->_init('scoreindex/price');
    ...
    public function addMinimalPrices(Shaurmalab_Score_Model_Resource_Oggetto_Collection $collection)
    {
