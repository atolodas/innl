...
/**
 * Resource Model ScoreIndex Aggregation
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreIndex
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreIndex_Model_Resource_Aggregation extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Table name of scoreindex/aggregation_tag table
     *
     * @var string
     */
    protected $_tagTable;
    ...
    /**
     * Table name of scoreindex/aggregation_to_tag table
     *
     * @var string
     */
    ...
    {
        $this->_init('scoreindex/aggregation', 'aggregation_id');
        $this->_tagTable    = $this->getTable('scoreindex/aggregation_tag');
        $this->_toTagTable  = $this->getTable('scoreindex/aggregation_to_tag');
    }
     ...
     * @param int $storeId
     * @return Shaurmalab_ScoreIndex_Model_Resource_Aggregation
     */
    ...
    /**
     * OggettoCategoryPaths getter
     *
     * @param array $oggettoIds
     * @return array
     */
    public function getOggettoCategoryPaths($oggettoIds)
    {
        // $select = $this->_getReadAdapter()->select()
        //     ->from(array('cat'=>$this->getTable('score/category')), 'path')
        //     ->joinInner(
        //         array('cat_prod'=>$this->getTable('score/category_oggetto')),
        //         $this->_getReadAdapter()->quoteInto(
        //             'cat.entity_id=cat_prod.category_id AND cat_prod.oggetto_id IN (?)',
        //             $oggettoIds
        //         ),
        //         array()
        //     );
