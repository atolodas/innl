 ...
 */
class Shaurmalab_ScoreIndex_Model_Resource_Attribute extends Shaurmalab_ScoreIndex_Model_Resource_Abstract
{
    /**
    ...
    {
        $this->_init('scoreindex/eav', 'index_id');
    }
...
//        $alias = $this->_getReadAdapter()->quoteTableAs($this->getMainTable(), 'index');
     ...
     * @return Shaurmalab_ScoreIndex_Model_Resource_Attribute
     */
