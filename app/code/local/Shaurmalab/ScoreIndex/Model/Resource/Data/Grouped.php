...
/**
 * ScoreIndex Grouped Oggettos Data Retriever Resource Model
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreIndex
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreIndex_Model_Resource_Data_Grouped extends Shaurmalab_ScoreIndex_Model_Resource_Data_Abstract
{
    /**
    ...
    public function getMinimalPrice($oggettos, $priceAttributes, $store)
    {
        ...
        foreach ($groups as $group) {
            ...
            $typedOggettos = Mage::getSingleton('scoreindex/retreiver')
                ->assignOggettoTypes($oggettos);
            foreach ($typedOggettos as $type=>$typeIds) {
