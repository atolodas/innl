 ...
 */
class Shaurmalab_ScoreSearch_Helper_Data extends Mage_Core_Helper_Abstract
{
     ...
     * Query object
     *
     * @var Shaurmalab_ScoreSearch_Model_Query
     */
    protected $_query;
     ...
     * Search engine model
     *
     * @var Shaurmalab_ScoreSearch_Model_Resource_Fulltext_Engine
     */
    protected $_engine;
    ...
    {
        if (!$this->_query) {
            $this->_query = Mage::getModel('scoresearch/query')
    ...
    {
        return $this->_getUrl('scoresearch/result', array(
    ...
    {
        return $this->_getUrl('scoresearch/ajax/suggest', array(
            '_secure' => Mage::app()->getFrontController()->getRequest()->isSecure()
        ));
    }
    ...
    {
        return $this->_getUrl('scoresearch/term/popular');
    }
    ...
    {
        return $this->_getUrl('scoresearch/advanced');
    }
    ...
    {
        return Mage::getStoreConfig(Shaurmalab_ScoreSearch_Model_Query::XML_PATH_MIN_QUERY_LENGTH, $store);
    }
    ...
    {
        return Mage::getStoreConfig(Shaurmalab_ScoreSearch_Model_Query::XML_PATH_MAX_QUERY_LENGTH, $store);
    }
    ...
    {
        return Mage::getStoreConfig(Shaurmalab_ScoreSearch_Model_Query::XML_PATH_MAX_QUERY_WORDS, $store);
    }
     ...
     * @return Shaurmalab_ScoreSearch_Helper_Data
     */
    ...
    public function checkNotes($store = null)
    {
       ...
       $searchType = Mage::getStoreConfig(Shaurmalab_ScoreSearch_Model_Fulltext::XML_PATH_CATALOG_SEARCH_TYPE);
       if ($searchType == Shaurmalab_ScoreSearch_Model_Fulltext::SEARCH_TYPE_COMBINE
            || $searchType == Shaurmalab_ScoreSearch_Model_Fulltext::SEARCH_TYPE_LIKE
        ) {
    ...
    {
        if (!$this->_engine) {
            $engine = Mage::getStoreConfig('score/search/engine');
            ...
            if (!$this->_engine) {
                $this->_engine = Mage::getResourceSingleton('scoresearch/fulltext_engine');
            }
        }
