...
class Shaurmalab_ScoreSearch_Model_Layer extends Shaurmalab_Score_Model_Layer
{
    const XML_PATH_DISPLAY_LAYER_COUNT = 'score/search/use_layered_navigation_count';

    /**
     * Get current layer oggetto collection
     *
    ...
    public function getOggettoCollection()
    {
        if (isset($this->_oggettoCollections[$this->getCurrentCategory()->getId()])) {
            ...
            $collection = Mage::getResourceModel('scoresearch/fulltext_collection');
    ...
    public function prepareOggettoCollection($collection)
    {
        $collection
            ...
            ->addSearchFilter(Mage::helper('scoresearch')->getQuery()->getQueryText())
      ...
      // TODO: return visibility filter later
    ...
    public function getStateKey()
    {
        if ($this->_stateKey === null) {
            $this->_stateKey = 'Q_' . Mage::helper('scoresearch')->getQuery()->getId()
    ...
    public function getStateTags(array $additionalTags = array())
    {
        ...
        $additionalTags[] = Shaurmalab_ScoreSearch_Model_Query::CACHE_TAG;
    ...
    protected function _prepareAttribute($attribute)
    {
        ...
        $attribute->setIsFilterable(Shaurmalab_Score_Model_Layer_Filter_Attribute::OPTIONS_ONLY_WITH_RESULTS);
        return $attribute;
    }
}
