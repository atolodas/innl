...
/**
 * Advanced Score Search resource model
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreSearch
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreSearch_Model_Resource_Advanced extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Initialize connection and define score oggetto table as main table
     *
     */
    ...
    public function addIndexableAttributeModifiedFilter($collection, $attribute, $value)
    {
        if ($attribute->getIndexType() == 'decimal') {
            $table = $this->getTable('score/oggetto_index_eav_decimal');
        } else {
            $table = $this->getTable('score/oggetto_index_eav');
        }
