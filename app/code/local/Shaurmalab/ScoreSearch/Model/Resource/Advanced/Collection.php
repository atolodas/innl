 ...
 */
class Shaurmalab_ScoreSearch_Model_Resource_Advanced_Collection extends Shaurmalab_Score_Model_Resource_Oggetto_Collection
{
    /**
                ...
                foreach ($conditions as $attributeId => $conditionValue) {
                    ...
                    if (is_array($conditionValue)) {
                        ...
                        elseif (isset($conditionValue['from']) && isset($conditionValue['to'])) {
                            $invalidDateMessage = Mage::helper('scoresearch')->__('Specified date is invalid.');
