...
/**
 * Score search query resource model
 *
 * @category    Mage
 * @package     Shaurmalab_ScoreSearch
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Shaurmalab_ScoreSearch_Model_Resource_Query extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Init resource data
     *
    ...
    {
        $this->_init('scoresearch/search_query', 'query_id');
    }
     ...
     * @param string $value
     * @return Shaurmalab_ScoreSearch_Model_Resource_Query
     */
