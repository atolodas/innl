  ...
  **/
  ...
  function convertToUserdate($date) {
      if (isset($_POST['tz']) && $_POST['tz'])
      {
          ...
          $dt->setTimezone(new DateTimeZone($_POST['tz']));
          $userdate = $dt->format('Y-m-d H:i:s');
