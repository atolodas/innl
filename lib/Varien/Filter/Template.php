...
class Varien_Filter_Template implements Zend_Filter_Interface
{
    ...
    const CONSTRUCTION_ISSET_PATTERN = '/{{isset\s*(.*?)}}(.*?){{\\/isset\s*}}/si';
     const CONSTRUCTION_FI_PATTERN = '/{{fi\s*(.*?)}}(.*?)({{elsefi}}(.*?))?{{\\/fi\s*}}/si';
    /**
    ...
    public function filter($value)
    {
        ...
        foreach (array(
            ...
            self::CONSTRUCTION_ISSET_PATTERN     => 'issetDirective',
               self::CONSTRUCTION_FI_PATTERN     => 'fiDirective',
